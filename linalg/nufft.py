...
class NUFFT(NUFFT_cpu, NUFFT_hsa):
    """
...
#                   )
    ...
    def plan(self, om, Nd, Kd, Jd, batch=None):
        switcher = {'cpu': self._plan(om, Nd, Kd, Jd, batch=None),
                            'hsa': self._plan(om, Nd, Kd, Jd, batch=None)}
#         switcher = {'cpu': print('using cpu plan'),
#                                 'hsa': print('using hsa plan')}
        print(self)
#         func = switcher.get(self.processor, lambda :'plan() failed')
        return switcher.get(self.processor, lambda :'plan() failed')
