...
and the sizes of the x-y axes are 256 and 256, respectively. 

Normally, the matrix size of k-space is twice the size of Nd. For example, 
...
This will not impact the dimensionality of the image reconstruction problem.  
...
.. figure:: ../figure/configuration_nufft.png
   ...
   The configuration of 1D, 2D, and 3D NUFFT. 
