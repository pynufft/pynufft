...
copyright = u'2012-2019, Jyh-Miin Lin'
...
version = u'DRAFT: Please do not cite or distribute without permission of the authors. '

# The full version, including alpha/beta/rc tags.
release = u'DRAFT: Please do not cite or distribute without permission of the authors. '
...
latex_documents = [('index', 'PyNUFFT.tex', u'PyNUFFT User Manual', u'Jyh-Miin Lin, MD, MSc, PhD', 'manual')]
...
man_pages = [('index', 'PyNUFFT', u'PyNUFFT Documentation', [u'Jyh-Miin Lin'], 1)]
