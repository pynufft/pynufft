...
release = u'2019.2.3(beta, J.-M. Lin) '
...
latex_documents = [('index', 'PyNUFFT.tex', u'PyNUFFT User Manual', u'J.-M. Lin', 'manual')]
...
man_pages = [('index', 'PyNUFFT', u'PyNUFFT Documentation', [u'J.-M. Lin'], 1)]
