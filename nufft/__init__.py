...
class NUFFT:
    ...
    # import host codes
    from ._nufft_class_methods_cpu import  _forward_host,  _adjoint_host, _selfadjoint_host,  _solve_host, _xx2k_host, _k2xx_host, _x2xx_host, _x2xx_host, _k2y_host,  _y2k_host, _adjoint_many2one_host, _forward_one2many_host, _selfadjoint_one2many2one_host, _reset_sense_host, _set_sense_host
    # import device codes
    ...
    def selfadjoint_one2many2one(self, *args, **kwargs):
        func = {'cpu': self._selfadjoint_one2many2one_cpu,
                ...
                'hsa_legacy': self._selfadjoint_one2many2one_host}
        return func.get(self.processor)(*args, **kwargs)   
